...
impl LocalFile {
  ...
  pub fn download_offset(&self) -> i32 { self.download_offset }

  pub fn downloaded_prefix_size(&self) -> i32 { self.downloaded_prefix_size }

  pub fn downloaded_size(&self) -> i32 { self.downloaded_size }
