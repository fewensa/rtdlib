...
impl MessageContent {
  ...
  pub fn is_message_dice(&self) -> bool { if let MessageContent::MessageDice(_) = self { true } else { false } }
  ...
  pub fn on_message_dice<F: FnOnce(&MessageDice)>(&self, fnc: F) -> &Self { if let MessageContent::MessageDice(t) = self { fnc(t) }; self }
  ...
  pub fn as_message_dice(&self) -> Option<&MessageDice> { if let MessageContent::MessageDice(t) = self { return Some(t) } None }
  ...
  pub fn message_dice<T: AsRef<MessageDice>>(t: T) -> Self { MessageContent::MessageDice(t.as_ref().clone()) }
...
pub struct MessageDice {
  ...
  success_animation_frame_number: i64,
  
}

impl RObject for MessageDice {
  #[doc(hidden)] fn td_name(&self) -> &'static str { "messageDice" }
  #[doc(hidden)] fn extra(&self) -> Option<String> { self.extra.clone() }
  fn to_json(&self) -> RTDResult<String> { Ok(serde_json::to_string(self)?) }
}
...
impl MessageDice {
  ...
  pub fn success_animation_frame_number(&self) -> i64 { self.success_animation_frame_number }
...
impl RTDMessageDiceBuilder {
  ...
  pub fn success_animation_frame_number(&mut self, success_animation_frame_number: i64) -> &mut Self {
...
impl AsRef<MessageDice> for MessageDice {
  fn as_ref(&self) -> &MessageDice { self }
}

impl AsRef<MessageDice> for RTDMessageDiceBuilder {
  fn as_ref(&self) -> &MessageDice { &self.inner }
}
